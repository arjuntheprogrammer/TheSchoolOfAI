...
Config.set('graphics', 'height', '843')
...
last_reward = 0
scores = []
im = CoreImage("./images/roads.png")

# Initializing the map
first_update = True
def init():
    print("inside init, longueur = ", longueur)
    print("inside init, largeur = ", largeur)
    ...
    img = PILImage.open("./images/roads_rotated.png").convert('L')
...
class Car(Widget):
    ...
    def move(self, rotation):
        ...
        self.sensor1 = Vector(20, 0).rotate(self.angle) + self.pos
